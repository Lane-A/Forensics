...
fn main() {
    ...
    const FILE_ISO :&str = "./FAT_Hidden.iso";
    ...
    //if beginning of file
        ...
        if temp.eq("FFD8FF") || temp.eq("89504E") || temp.eq("3C2144")|| temp.eq("0D444F") || temp.eq("CF11E0") || temp.eq("DBA52D") || temp.eq("ECA5C1") || temp.eq("474946") || temp.eq("D0CF11") || temp.eq("3C6874") || temp.eq("255044") || temp.eq("504B03"){
      ...
      //  println!("initial temp pointer: {}", temp_pointer);
        ...
        while !eof {
            ...
            if format!("{}{}{}{}", data[mega_pointer + temp_pointer + 3], data[mega_pointer + temp_pointer + 2], data[mega_pointer + temp_pointer + 1], data[mega_pointer + temp_pointer + 0]).eq("00000000") && first{
                ...
                else if format!("{}{}{}{}", data[mega_pointer + temp_pointer + 3], data[mega_pointer + temp_pointer + 2], data[mega_pointer + temp_pointer + 1], data[mega_pointer + temp_pointer + 0]).eq("00000000") {
                    eof = true;
                }
                else{
                    //save cluster #s
